        ...
        <div className="testimonials-wrapper">
          <div className="border-one">
            <p className="testimonials-desc">
              “We are incredibly pleased with the outstanding services provided
              by AD Vinci. Their expertise in social media advertising has been
          ...
          <div className="border-three">
            <p className="testimonials-desc">
              “We are thrilled with the exceptional service and results
              delivered by AD Vinci. Their team's expertise in social media
              advertising has taken our brand, Dua.com, to new heights.
            </p>
            <div className="img-wrapper">
